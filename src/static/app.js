document.addEventListener("DOMContentLoaded", () => {
    ...
    activityCard.innerHTML = `
      ...
      <div class="social-share-container">
        ...
        <div class="social-share-buttons">
          ...
          <button class="share-button share-copy" data-activity="${name}" data-description="${details.description.replace(/"/g, '&quot;')}" data-schedule="${formattedSchedule.replace(/"/g, '&quot;')}" title="Copy link to clipboard">
  ...
  function handleShare(event) {
    ...
    // Generate share URL - using current page URL with activity name as hash
